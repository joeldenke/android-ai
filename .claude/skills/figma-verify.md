...
When the user runs `/figma-verify [screen or component]`, connect to Figma via MCP, pull the design spec, and compare it against the Compose implementation. Report all deviations.
