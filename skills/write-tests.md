...
```kotlin
// Compose UI test — no DI framework required; inject fakes directly via setContent
class HomeScreenTest {
    ...
    fun `shows loading indicator while data loads`() {
        ...
        composeRule.setContent { AppTheme { HomeScreen(viewModel = viewModel, onNavigateToDetail = {}) } }
